...
const authorizeEndpoint = "/oauth2/v2.0/authorize";
const tokenEndpoint = "/oauth2/v2.0/token";
const scope =
  "Calendars.ReadWrite.Shared Contacts.ReadWrite.Shared offline_access";
...
export const getAuthUrl = () => {
  return (
    ...
    authorizeEndpoint +
    "?client_id=" +
    "b172c03f-be43-42e9-b17a-34fe50574266" +
    "&response_type=code" +
    "&scope=" +
    scope +
    "&redirect_uri=" +
...
export const getEvents = (startDate, endDate, accessToken) => {
  ...
  let url =
    "https://graph.microsoft.com/v1.0/me/calendarView?$top=10000&startDateTime=" +
    startDate +
    "&endDateTime=" +
    endDate;
...
const sendNotification = () => {
  ...
  let payload = {
    topic: {
      ...
      webUrl:
        "https://teams.microsoft.com/l/entity/6c75be83-05a8-4515-9c7b-b5f759b99b7f/joyeapp",
    },
