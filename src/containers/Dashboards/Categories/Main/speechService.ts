...
export default class SpeechService {
  ...
  static async predictionEx(procId, todaysFeelingText) {
    return new Promise((resolve, reject) => {
      ...
      console.log(data);
      axios
        .post("https://express-app-328308.as.r.appspot.com/backend/predictionService", data, config)
        .then((x) => {
  ...
  static async prediction(todaysFeelingText) {
    ...
    console.log(data);
    return await axios.post("https://express-app-328308.as.r.appspot.com/backend/predictionService", data, config);
  }
}
