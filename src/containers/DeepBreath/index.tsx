            ...
            {counter > 0 && !analysisPage ? (
              <>
                ...
                <div className="player-wrapper">
                  <ReactPlayer className="react-player" light={true} playsinline={true} muted={!this.state.audioMute} playing={this.state.isPlaying} pip={false} stopOnUnmount={this.state.isStop} url={this.state.viedoUrl} width="100%" height="100%" />
