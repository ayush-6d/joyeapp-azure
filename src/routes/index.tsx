...
export const NotFound = asyncComponent(
    () => import('src/containers/NotFound/index'),
    'NotFound'
);
export const Dashboard = asyncComponent(
    () => import('src/containers/Dashboards/Categories/index'),
    'Dashboard'
);
export const Journal = asyncComponent(
    () => import('src/containers/journal/index'),
    'Journal'
);
export const WelcomeScreen = asyncComponent(
    () => import('src/containers/WelcomeScreen/index'),
    'WelcomeScreen'
);
export const Configure = asyncComponent(
    () => import('src/containers/configure'),
    'Configure'
);
export const SignInStart = asyncComponent(
    () => import('src/containers/Login/sign-in-start'),
    'SignInStart'
);
export const SignInEnd = asyncComponent(
    () => import('src/containers/Login/sign-in-end'),
    'SignInEnd'
);
